...
{
    public abstract class GARAJWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GARAJWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GARAJWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GARAJDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GARAJDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GARAJDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GARAJDbContext, Task<T>> func)
        {
            T result;
